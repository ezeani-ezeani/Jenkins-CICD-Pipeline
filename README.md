...
1) ###### GitHub setup
    Fork GitHub Repository by using the existing repo "devops-fully-automated" (https://github.com/ezeani-ezeani/Jenkins-CICD-Pipeline.git)     
    - Go to GitHub (github.com)
    - Login to your GitHub Account
    - **Fork repository "Jenkins-CICD-Pipeline" (https://github.com/ezeani-ezeani/Jenkins-CICD-Pipeline.git) & name it "Jenkins-CICD-Pipeline"**
...
2) ###### Jenkins/Maven/Ansible
    ...
    - User data (Copy the following user data): https://github.com/ezeani-ezeani/Jenkins-CICD-Pipeline.git/jenkins-maven-ansible-setup.sh
    - Launch Instance
...
3) ###### SonarQube
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/ezeani-ezeani/Jenkins-CICD-Pipeline.git/sonarqube-setup.sh
    - Launch Instance
...
4) ###### Nexus
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/ezeani-ezeani/Jenkins-CICD-Pipeline.git/nexus-setup.sh
    - Launch Instance
...
5) ###### EC2 (Dev/Stage/Prod)
    ...
    - Security Group (Open): 8080, 9100 and 22 to 0.0.0.0/0
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/ezeani-ezeani/Jenkins-CICD-Pipeline.git/deployment-servers-setup.sh
    - Launch Instance
...
6) ###### Prometheus
    ...
    - User data (Copy the following user data): https://github.com/ezeani-ezeani/Jenkins-CICD-Pipeline.git/prometheus-setup.sh
    - Launch Instance
...
7) ###### Grafana
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/ezeani-ezeani/Jenkins-CICD-Pipeline.git/grafana-setup.sh
    - Launch Instance
